<?php
  function btndangnhap(){
    if (!isset($_SESSION['username'])) {
        echo '<a href="dangnhap.html"><button type="button" class="btn btn-primary">ĐĂNG NHẬP</button></a>';
    }
    else{
        echo  '<a href="dangxuat.php"><button type="button" class="btn btn-primary">ĐĂNG XUẤT</button></a>';
    }
  }
  function qltk(){
    if (isset($_SESSION['username']) && $_SESSION['username']=="admin") {
        echo '<li class="nav-item mx-3"><a href="qltaikhoan.php" class="nav-link px-2">TÀI KHOẢN</a></li>';
        echo '<li class="nav-item mx-3"><a href="trlienhe.php" class="nav-link px-2">LIÊN HỆ</a></li>';
    }
    else{
        echo "";
    }
  ...
  <main class="main">
    <div class="container">
      <header
        ...
        <div>
          <ul class="nav">
            <li class="nav-item mx-3"><a href="index.php" class="nav-link px-2">TRANG CHỦ</a></li>
